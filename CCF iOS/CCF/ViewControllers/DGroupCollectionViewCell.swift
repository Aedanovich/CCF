//
//  DGroupCollectionViewCell.swift
//  CCF
//
...
class DGroupCollectionViewCell: UICollectionViewCell {
...
//        let annotationView: CCFPinAnnotationView = CCFPinAnnotationView(annotation: annotation, reuseIdentifier: AnnotationIdentifier)
